...
#> ℹ In argument: `h0 = silv_dominant_height(dclass, height, ntrees_ha)`.
#> ℹ In group 1: `plot_id = 7`, `species = 27`.
#> Caused by warning:
#> ! `silv_dominant_height()` was deprecated in silviculture 0.2.0.
#> ℹ Function `silv_dominant_height() is deprecated in favour of
#>   `silv_stand_dominant_height()`, and it will be removed in the next release.
#> # A tibble: 57 × 7
